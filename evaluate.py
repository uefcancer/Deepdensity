...
def parse_args():
    ...
    parser.add_argument('--dataset', default='DDSM_Dataset', type=str, help='Mammogram view')
    ...
    parser.add_argument('--model_save_path', default='MG_DDSM/models/unet.pth', type=str, help='path to save the model')  # change here

    parser.add_argument('--results_path', default='MG_DDSM/evaluation/kys_mias.txt', type=str,
...
test_dataset = KUHDataset(path=config['data_path'], dataset=config['dataset'], split='test',augmentations=None)
